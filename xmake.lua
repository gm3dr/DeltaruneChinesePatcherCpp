add_requires("raylib", "cpr", "nlohmann_json", "picosha2", "nativefiledialog-extended", "tinyfiledialogs")
...
target("deltarune_cnpatcher")
    ...
    add_files("src/**/*.cpp")
    add_packages("raylib", "nlohmann_json", "cpr", "picosha2", "nativefiledialog-extended", "tinyfiledialogs")
